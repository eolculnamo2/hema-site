        ...
        <div className="footer-at-bottom">
          ...
          <Switch>
            ...
            {<Route
              ...
              render={() => (loggedIn ? <CreateTournament /> : <Redirect to="/login" />)}
            />}
            {<Route
              exact
              path="/event-registration"
              render={() => (loggedIn ? <RegisterForEvent /> : <Redirect to="/login" />)}
            />}
            {<Route
              exact
              path="/manage-tournaments"
              render={() => (loggedIn ? <MyTournaments /> : <Redirect to="/login" />)}
            />}
            <Route
              exact
            ...
            {<Route
              exact
              path="/manage-tournaments/:tId/:event"
              render={props => (loggedIn ? <MyEventView {...props} /> : <Redirect to="/login" />)}
            />}
            <Route
              exact
              path="/admin"
